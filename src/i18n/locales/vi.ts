...
,
  ...
  'our': 'Sản phẩm',
  'products': 'Của chúng tôi',
  'Explore our comprehensive range of fire protection solutions.': 'Khám phá toàn bộ các giải pháp bảo vệ chống cháy của chúng tôi.',
  ...
  'industry.solutions':'Giải pháp ngành công nghiệp',
  'usecase.description':"Giải pháp thực tiễn mang lại kết quả đo lường được trên nhiều ngành công nghiệp khác nhau. Xem cách chúng tôi đã biến đổi hoạt động.",
  'facilities.description2':'Các cơ sở được đặt chiến lược trên khắp Bắc Mỹ, được trang bị công nghệ hiện đại và các chứng nhận ngành công nghiệp.',
  'get.your.custom.quote.today': 'Nhận báo giá tùy chỉnh của bạn ngay hôm nay',
  'get.your.custom.quote.description': 'Nhận báo giá tùy chỉnh phù hợp với nhu cầu logistics và sản xuất cụ thể của bạn. Chúng tôi thường phản hồi trong vòng 24 giờ với một đề xuất toàn diện.',
    'response.time':'Thời gian phản hồi',
  'happy.clients':'Khách hàng hài lòng',
  'on.time.rate':'Tỷ lệ đúng hạn',
  'need.help': 'Cần giúp đỡ?',
  'phone': 'Điện thoại',
  'email': 'Email',
  'live.chat': 'Trò chuyện trực tiếp',
  'why.choose.us': 'Tại sao chọn chúng tôi?',
  'industry.experience': 'Hơn 25 năm kinh nghiệm trong ngành',
  'on.time.delivery.rate': 'Tỷ lệ giao hàng đúng hạn 99,9%',
  'certified.facilities': 'Cơ sở được chứng nhận ISO 9001',
  'customer.support': 'Hỗ trợ khách hàng 24/7',
  'time': 'Thứ Hai đến Thứ Sáu, 9 giờ sáng đến 7 giờ tối (Giờ Bắc Kinh)',
  '24-hour.response.time': 'Thời gian phản hồi 24 giờ',
  'available.on.website': 'Có sẵn trên trang web',
  'instant.support':' Hỗ trợ tức thì',
} as const;